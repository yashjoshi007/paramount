          ...
          children: [ // Add some space between the buttons and the DataTable
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: [
                  _buildDetailRow('Similar', articleDetails['Similar']=='' ? 'N/A':  articleDetails['Similar']),
                  _buildDetailRow('Compo', '${articleDetails['Compo'] ?? 'N/A'}'),
                  if (userRole == 'colleague' || userRole == 'Colleague') _buildDetailRow('Texture', '${articleDetails['Texture'] ?? 'N/A'}'),
                  if (userRole == 'colleague' || userRole == 'Colleague') _buildDetailRow('Finish', '${articleDetails['Finish'] ?? 'N/A'}'),
                  _buildDetailRow('Used WT', '${articleDetails['UsedWT'] ?? 'N/A'}'),
                  _buildDetailRow('Width', '${articleDetails['Width'] ?? 'N/A'}'),
                  _buildDetailRow('Color Code', '${articleDetails['ColorCode'] ?? 'N/A'}'),
                  _buildDetailRow('E.Color', '${articleDetails['E_Color'] ?? 'N/A'}'),
